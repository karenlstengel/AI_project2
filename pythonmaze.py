...
class Graph:
    ...
    def getNext(self, x, y, smartDumb): #returns next square, varying depending on whether we're using dumb or smart algorithm
        if smartDumb == "dumb":
